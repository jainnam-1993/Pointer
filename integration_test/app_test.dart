...
void main() {
  ...
  group('App Launch and Initial State', () {
    testWidgets('fresh app launch shows onboarding screen', (WidgetTester tester) async {
    ...
    testWidgets('app with completed onboarding shows home screen', (WidgetTester tester) async {
    ...
    testWidgets('home screen displays pointing content card', (WidgetTester tester) async {
      final app = await createTestApp(onboardingCompleted: true);
      await tester.pumpWidget(app);
      await pumpAndSettle(tester);
  ...
  group('Bottom Navigation Tabs', () {
    testWidgets('home tab is active by default', (WidgetTester tester) async {
      final app = await createTestApp(onboardingCompleted: true);
      await tester.pumpWidget(app);
      await pumpAndSettle(tester);
    ...
    testWidgets('can navigate to Inquiry tab', (WidgetTester tester) async {
      final app = await createTestApp(onboardingCompleted: true);
      await tester.pumpWidget(app);
      await pumpAndSettle(tester);
    ...
    testWidgets('can navigate to Lineages tab', (WidgetTester tester) async {
      final app = await createTestApp(onboardingCompleted: true);
      await tester.pumpWidget(app);
      await pumpAndSettle(tester);
    ...
    testWidgets('can return to Home tab after navigation', (WidgetTester tester) async {
      final app = await createTestApp(onboardingCompleted: true);
      await tester.pumpWidget(app);
      await pumpAndSettle(tester);
    ...
    testWidgets('navigation maintains tab state', (WidgetTester tester) async {
      final app = await createTestApp(onboardingCompleted: true);
      await tester.pumpWidget(app);
      await pumpAndSettle(tester);
  ...
  group('Home Pointing Interaction', () {
    testWidgets('tapping Next Pointing changes content', (WidgetTester tester) async {
      final app = await createTestApp(onboardingCompleted: true);
      await tester.pumpWidget(app);
      await pumpAndSettle(tester);
    ...
    testWidgets('multiple taps on Next Pointing are stable', (WidgetTester tester) async {
      final app = await createTestApp(onboardingCompleted: true);
      await tester.pumpWidget(app);
      await pumpAndSettle(tester);
    ...
    testWidgets('home screen shows tradition badge', (WidgetTester tester) async {
      final app = await createTestApp(onboardingCompleted: true);
      await tester.pumpWidget(app);
      await pumpAndSettle(tester);

      // Tradition badge should be visible (contains one of the tradition names)
      final traditions = ['Advaita Vedanta', 'Zen Buddhism', 'Direct Path', 'Contemporary', 'Original'];
  ...
  group('Inquiry Sessions', () {
    testWidgets('inquiry screen shows intro card', (WidgetTester tester) async {
      final app = await createTestApp(onboardingCompleted: true);
      await tester.pumpWidget(app);
      await pumpAndSettle(tester);
      ...
      expectTextVisible('Self-Inquiry');
      expect(findTextContaining('These sessions guide you through'), findsOneWidget);
      expect(findTextContaining('Each session is 5-15 minutes'), findsOneWidget);
    }, tags: [TestTags.sessions]);

    testWidgets('inquiry screen shows free sessions', (WidgetTester tester) async {
      final app = await createTestApp(onboardingCompleted: true);
      await tester.pumpWidget(app);
      await pumpAndSettle(tester);
    ...
    testWidgets('inquiry screen shows session metadata', (WidgetTester tester) async {
      final app = await createTestApp(onboardingCompleted: true);
      await tester.pumpWidget(app);
      await pumpAndSettle(tester);
    ...
    testWidgets('can tap on free session', (WidgetTester tester) async {
      final app = await createTestApp(onboardingCompleted: true);
      await tester.pumpWidget(app);
      await pumpAndSettle(tester);
    ...
    testWidgets('shows premium sessions', (WidgetTester tester) async {
      final app = await createTestApp(onboardingCompleted: true);
      await tester.pumpWidget(app);
      await pumpAndSettle(tester);
  ...
  group('Lineages Screen', () {
    testWidgets('lineages screen shows header', (WidgetTester tester) async {
      final app = await createTestApp(onboardingCompleted: true);
      await tester.pumpWidget(app);
      await pumpAndSettle(tester);
    ...
    testWidgets('lineages screen shows traditions with pointings count', (WidgetTester tester) async {
      final app = await createTestApp(onboardingCompleted: true);
      await tester.pumpWidget(app);
      await pumpAndSettle(tester);
    ...
    testWidgets('lineages screen shows all traditions', (WidgetTester tester) async {
      final app = await createTestApp(onboardingCompleted: true);
      await tester.pumpWidget(app);
      await pumpAndSettle(tester);
    ...
    testWidgets('can tap on tradition card', (WidgetTester tester) async {
      final app = await createTestApp(onboardingCompleted: true);
      await tester.pumpWidget(app);
      await pumpAndSettle(tester);
  ...
  group('Settings Screen', () {
    testWidgets('settings screen shows notifications section', (WidgetTester tester) async {
      final app = await createTestApp(onboardingCompleted: true);
      await tester.pumpWidget(app);
      await pumpAndSettle(tester);
    ...
    testWidgets('settings screen shows traditions section', (WidgetTester tester) async {
      final app = await createTestApp(onboardingCompleted: true);
      await tester.pumpWidget(app);
      await pumpAndSettle(tester);
    ...
    testWidgets('settings screen shows history section', (WidgetTester tester) async {
      final app = await createTestApp(onboardingCompleted: true);
      await tester.pumpWidget(app);
      await pumpAndSettle(tester);
    ...
    testWidgets('settings screen shows account section for free user', (WidgetTester tester) async {
    ...
    testWidgets('settings screen shows premium active for premium user', (WidgetTester tester) async {
    ...
    testWidgets('settings screen shows about section', (WidgetTester tester) async {
      final app = await createTestApp(onboardingCompleted: true);
      await tester.pumpWidget(app);
      await pumpAndSettle(tester);
    ...
    testWidgets('notification toggle switch is interactive', (WidgetTester tester) async {
      final app = await createTestApp(onboardingCompleted: true);
      await tester.pumpWidget(app);
      await pumpAndSettle(tester);
  ...
  group('Onboarding Flow', () {
    testWidgets('onboarding shows welcome page first', (WidgetTester tester) async {
      final app = await createTestApp(onboardingCompleted: false);
      await tester.pumpWidget(app);
      await pumpAndSettle(tester);
      ...
      expectTextVisible('Welcome to Pointer');
      expectTextVisible('Direct invitations to recognize what you already are');
      expect(findTextContaining('Each pointing is a finger pointing at the moon'), findsOneWidget);
      expectTextVisible('Continue');
    }, tags: [TestTags.onboarding]);

    testWidgets('onboarding shows traditions page', (WidgetTester tester) async {
      final app = await createTestApp(onboardingCompleted: false);
      await tester.pumpWidget(app);
      await pumpAndSettle(tester);
    ...
    testWidgets('onboarding shows daily pointings page', (WidgetTester tester) async {
      final app = await createTestApp(onboardingCompleted: false);
      await tester.pumpWidget(app);
      await pumpAndSettle(tester);
    ...
    testWidgets('onboarding shows notifications page last', (WidgetTester tester) async {
      final app = await createTestApp(onboardingCompleted: false);
      await tester.pumpWidget(app);
      await pumpAndSettle(tester);
    ...
    testWidgets('skipping notifications completes onboarding', (WidgetTester tester) async {
      final app = await createTestApp(onboardingCompleted: false);
      await tester.pumpWidget(app);
      await pumpAndSettle(tester);
    ...
    testWidgets('enabling notifications completes onboarding', (WidgetTester tester) async {
      final app = await createTestApp(onboardingCompleted: false);
      await tester.pumpWidget(app);
      await pumpAndSettle(tester);
    ...
    testWidgets('onboarding shows page indicators', (WidgetTester tester) async {
      final app = await createTestApp(onboardingCompleted: false);
      await tester.pumpWidget(app);
      await pumpAndSettle(tester);
  ...
  // ============================================================
  group('Smoke Tests', () {
    testWidgets('critical user flow - launch to pointing interaction', (WidgetTester tester) async {
      final app = await createTestApp(onboardingCompleted: true);
      await tester.pumpWidget(app);
      await pumpAndSettle(tester);
    ...
    testWidgets('critical user flow - fresh install to home', (WidgetTester tester) async {
      final app = await createTestApp(onboardingCompleted: false);
      await tester.pumpWidget(app);
      await pumpAndSettle(tester);
