...
- Text-to-speech audio playback (premium feature)
- Home screen widget
...
## 3. Premium Features and Purchases
...
- Google Play's refund policies apply: [Google Play Refund Policy](https://support.google.com/googleplay/answer/2479637)

### 3.3 Purchase Restoration

If you reinstall the app or switch devices, you can restore your purchase through the app settings using the same Google account.
...
Content is attributed to its respective teachers and traditions where known. We respect the lineages and teachers whose wisdom is shared through the app.

### 4.3 User Interpretation

You are solely responsible for how you interpret and apply any content from the app. Individual experiences with contemplative practices vary.
...
- Redistribute or commercially exploit app content without permission
...
Many pointings in the app are from public domain sources or are traditional teachings. We do not claim ownership of these teachings.
...
- Our total liability shall not exceed the amount you paid for premium features
...
Your use of the app is also governed by our [Privacy Policy](/privacy), which describes how we collect and use your information.
...
We reserve the right to modify, suspend, or discontinue the app or any features at any time without notice.

---

## 11. Termination

We may terminate or suspend your access to the app at any time for violation of these Terms. Upon termination, your license to use the app ends immediately.
