 ...
 *
 * Defines [Pointing] and the master `pointings` list plus helper query functions.
 * [Tradition], [PointingContext], [TraditionInfo], and [traditions] are defined in
 * `models/tradition.dart` and re-exported here for backward compatibility.
 *
