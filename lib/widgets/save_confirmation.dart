          ...
          child: Column(
            ...
            children: [
              TweenAnimationBuilder<double>(
                ...
                child: Icon(Icons.favorite, color: Theme.of(context).colorScheme.primary, size: 48),
              ),
              const SizedBox(height: 12),
              Text(
                'Saved',
                style: TextStyle(color: colors.textPrimary, fontSize: 16, fontWeight: FontWeight.w500, letterSpacing: 0.5),
              ),
            ],
          ),
        ),
